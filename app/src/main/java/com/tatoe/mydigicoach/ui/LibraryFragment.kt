...
class LibraryFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        libraryViewModel = ViewModelProviders.of(
            this,
            MyLibraryViewModelFactory(activity!!.application, db)
        ).get(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        myExercisesAdapter = MyCustomExercisesAdapter(activity!!)
        search_view.isIconified = true

        libraryExercisesList.layoutManager = LinearLayoutManager(activity!!)
...
//                toImportExercises.remove(exe)
    ...
    private fun showFilterDialog() {
        ...
        val mDialogView =
            LayoutInflater.from(activity!!).inflate(R.layout.dialog_window_library_filter, null)
        var customCategoriesAdapter = MyCustomCategoriesAdapter(activity!!)
    ...
    private fun initObservers() {
        ...
        libraryViewModel.isInsertingExercises.observe(this, Observer {
            if (isInserting && !it) {
                progressBar_cyclic.visibility = View.GONE
                Toast.makeText(activity!!, "Exercises imported", Toast.LENGTH_SHORT).show()
