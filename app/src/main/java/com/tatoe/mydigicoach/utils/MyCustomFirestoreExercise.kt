...
class MyCustomFirestoreExercise(exercise: Exercise) {
    ...
    var fieldsMap: HashMap<String, HashMap<String, String>> = pairToHashMap(exercise.fieldsHashMap)

    var resultsFieldsMap: HashMap<String, HashMap<String, String>> =
        pairToHashMap(exercise.exerciseResults.resultFieldsMap)

    var resultsArrayList: ArrayList<HashMap<String, HashMap<String, String>>> =
        arrayListPairToHashMap(exercise.exerciseResults.resultsArrayList)

    fun toExercise(): Exercise {
        var exercise = Exercise(Exercise.stringMapToIntMap(hashMapToPair(fieldsMap)))
        exercise.exerciseResults.resultFieldsMap = hashMapToPair(resultsFieldsMap)
        exercise.exerciseResults.resultsArrayList = arrayListHashMapToPair(resultsArrayList)
        return exercise
    }
